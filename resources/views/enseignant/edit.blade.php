...
@section("contenu")
    ...
    <form action="{{ route('update_enseignant') }}"  method="post">
        ...
        <div class="form-row mt-4">
            <div class="col">
                ...
                <input type="hidden" name="id" class="form-control" value="{{ $enseignant->id }}">
        ...
        <div class="form-row mt-4">
            <div class="col">
                ...
                @foreach( $codes as $codes_ )
                    @if( $codes_->id == $enseignant->code->id )
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="code_id" id="code_id" value="{{ $codes_->id }}" checked="checked">
            ...
            <div class="col">
                ...
                <select name="grade_id" class="form-control">
                    ...
                    @foreach( $grades as $grades_ )
                        @if($grades_->id == $enseignant->grade->id)
                            <option value="{{ $grades_->id }}" selected>{{ $grades_->grade }}</option>
                        @else
        ...
        <div class="form-row mt-4">
            <div class="col">
                ...
                <input type="text" name="im" class="form-control" value="{{ $enseignant->im }}">
                @error('im')
                    <p class="alert-danger rounded mt-2 px-2 py-1" role="alert">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="form-row mt-4">
            ...
            <div class="col">
                ...
                <input type="text" name="contact" class="form-control" value="{{ $enseignant->contact }}">
                @error('contact')
                    <p class="alert-danger rounded mt-2 px-2 py-1" role="alert">{{ $message }}</p>
                @enderror
            </div>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a class="btn btn-danger" href="{{ route('edit_enseignant' , [ 'id'=>$enseignant->id ]) }}">Non</a>
                        </div>
                      </div>
                    </div>
                </div>
