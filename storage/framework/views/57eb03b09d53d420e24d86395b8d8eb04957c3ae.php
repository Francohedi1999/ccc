<?php $__env->startSection("contenu"); ?>
    ...
    <form action="<?php echo e(route('update_ec')); ?>"  method="post" id="ec_ens">
            ...
            <div class="col">
                ...
                <select name="elc_id" id="elc_id" class="form-control">
                    ...
                    <?php $__currentLoopData = $ecs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ecs_): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if( $ecs_->id == $ec_ens->elc_id ): ?>
                            <option value="<?php echo e($ecs_->id); ?>" selected><?php echo e($ecs_->ec); ?></option>
                        <?php else: ?>
                ...
                <input type="hidden" class="form-control" name="id" id="id" value="<?php echo e($ec_ens->id); ?>">
            ...
            <div class="col">
                ...
                <select name="ens_id" id="ens_id" class="form-control">
                    ...
                    <?php $__currentLoopData = $enseignants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enseignants_): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if( $enseignants_->id == $ec_ens->ens_id ): ?>
                            <option value="<?php echo e($enseignants_->id); ?>" selected><?php echo e($enseignants_->nom." ".$enseignants_->prenom); ?></option>
                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col">
                ...
                <input type="text" class="form-control" name="credit" id="credit" value="<?php echo e(round( $ec_ens->credit )); ?>">
...
<?php echo $__env->make("layout.template", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\EGS\egs\resources\views/ec/edit.blade.php ENDPATH**/ ?>