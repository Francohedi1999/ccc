<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-item nav-link" href="<?php echo e(route( 'ecs' )); ?>">E.C</a>
            </li>
        </ul>
...
<?php /**PATH C:\xampp\htdocs\Laravel\EGS\egs\resources\views/enseignant/navigation.blade.php ENDPATH**/ ?>